...
def getBus(line_name):
    ...
    for i in range(l0):
        url2 = "http://apps.eshimin.com/traffic/gjc/getArriveBase?name=" + name + '&lineid=' + line_id + '&direction=0&stopid=' + str(i)
        ...
        if arrivebase:
            if arrivebase['cars'][0]['stopdis'] == '1':
                result += arrivebase['cars'][0]['terminal'] + ' 距离 ' + busstop['lineResults0']['stops'][i][
                    'zdmc'] + ' ' + arrivebase['cars'][0]['distance'] + ' 米 ' + arrivebase['cars'][0][
                              'time'] + ' 秒 ' + '\n'
    if busstop['lineResults1']['stops']:
        ...
        for i in range(l1):
            url3 = "http://apps.eshimin.com/traffic/gjc/getArriveBase?name=" + name + '&lineid=' + line_id + '&direction=1&stopid=' + str(i)
            ...
            if arrivebase1:
                if arrivebase1['cars'][0]['stopdis'] == '1':
                    result += arrivebase1['cars'][0]['terminal'] + ' 距离 ' + busstop['lineResults0']['stops'][i]['zdmc'] + ' ' + arrivebase1['cars'][0]['distance'] + ' 米 ' + arrivebase1['cars'][0]['time'] + ' 秒 ' + '\n'
    return result
